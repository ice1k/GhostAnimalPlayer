...
public class  Constants {
    ...
    public static final String FILENAME = "works";
    public static final String FILENAMES = "all works";
    public static final String JSON = "W";
    public static final String SPLITTER = " ";
    public static final String ORIGINAL_NAME = "EJRIOWJOIEWJF";
    public static final String ORIGINAL_NAME_ID = "EJRIIEWJF";
    public static final String NEW_NAME = "HJKHJ";
    public static final String DELETE = "FYGHUJG";
    //判断文件是否存在
    ;
